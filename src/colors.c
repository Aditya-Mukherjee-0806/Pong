...
const RGB24 RGB24_BLACK = {0, 0, 0};
const RGB24 RGB24_RED = {255, 0, 0};
const RGB24 RGB24_GREEN = {0, 255, 0};
const RGB24 RGB24_BLUE = {0, 0, 255};
const RGB24 RGB24_YELLOW = {255, 255, 0};
const RGB24 RGB24_CYAN = {0, 255, 255};
const RGB24 RGB24_MAGENTA = {255, 0, 255};
const RGB24 RGB24_WHITE = {255, 255, 255};
